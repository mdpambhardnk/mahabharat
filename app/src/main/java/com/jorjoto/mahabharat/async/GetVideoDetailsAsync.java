...
public class GetVideoDetailsAsync {
    private Activity activity;
    private RequestModel requestModel;
    private JSONObject jObject;

    public GetVideoDetailsAsync(final Activity activity, RequestModel requestModel) {
        ...
        try {
            ...
            Call<ResponseModel> call = apiService.getVideodetail("get_video_detail", requestModel.getVideo_id());
    ...
    protected void onPostExecute(ResponseModel responseModel) {
        try {
            if (responseModel.getStatus().equals(Global_App.STATUS_SUCCESS)) {
                ((YouTubeVideoActivity)activity).setVideoData(activity, responseModel);
