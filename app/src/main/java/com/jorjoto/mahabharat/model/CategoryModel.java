...
public class CategoryModel {
    String videoId, videoTitle, videoDescription, videoLink,videoThumb,image,title,message,setVideoId,redirectScreen,notificationID;
    ...
    public void setSetVideoId(String setVideoId) {
