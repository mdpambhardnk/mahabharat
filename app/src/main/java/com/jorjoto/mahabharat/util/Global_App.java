...
public class Global_App {
    ...
    public static final String YOUTUBE_API_KEY = "AIzaSyALAhK6rxwIZwPnLryk8XdmR25enIcMjkA";
    public static String refreshedToken = "";
    public static String APPNAME = "Mahabharat";
    ...
    public static String FEEDBACK_EMAIL = "care.jorjoto@gmail.com";
